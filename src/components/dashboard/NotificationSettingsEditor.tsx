...
const ROWS: Row[] = [
  { id: "new_order", label: "New Order", description: "When a new sales order is created", icon: ShoppingCart },
  { id: "low_stock", label: "Low Stock Alert", description: "When product stock falls below minimum", icon: AlertTriangle },
  { id: "new_customer", label: "New Customer", description: "When a new customer registers", icon: Users },
  { id: "purchase_received", label: "Purchase Received", description: "When a purchase order is received", icon: Package },
];
